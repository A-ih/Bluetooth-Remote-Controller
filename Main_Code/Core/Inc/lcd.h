...
#define      FSMC_Addr_LCD_CMD         ( ( uint32_t ) 0x6C000000 )
#define      FSMC_Addr_LCD_DATA        ( ( uint32_t ) 0x6C000080 )
...
void 		LCD_DrawBitmap      (uint16_t usC, uint16_t usP, uint16_t img_width, uint16_t img_height, uint16_t* bitmap);
void 		LCD_DrawBitmap2432      (uint16_t usC, uint16_t usP, uint16_t img_width, uint16_t img_height, uint16_t* bitmap);
